...
config. BgColor 		= '#ffffcc' // Background color
...
config. FontFace		= 'Lucida Console,Courier New,sans-serif'
...
config. TitleFontFace	= 'Lucida Console,Courier New,sans-serif'	// If '' use FontFace (boldified)
config. TitleFontSize	= '16'		// If '' use FontSize
...
function tt_FormatTip()
{
	...
	if(tt_aV[TITLE].length)
	{
		...
		css.paddingTop = (tt_aV[CLOSEBTN] ? 2 : 3) + "px";
