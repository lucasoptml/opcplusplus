...
function AddFilters(proj)
{
	try
	{
		...
		SourceFilter = group;
		SourceFilter.Filter = "cpp";

		// Add the folders to your project
		HeaderFilter = proj.Object.AddFilter('Header Files');
		HeaderFilter.Filter = "h";
		
		DialectFilter = proj.Object.AddFilter('Dialect Files');
		DialectFilter.Filter = "doh";
		
		opFilter = proj.Object.AddFilter('opC++ Files');
		opFilter.Filter = "oh";
